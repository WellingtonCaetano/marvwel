                            ...
                            <table class="table table-bordered table-striped">		      
                                ...
                                <tbody>
                                    <c:forEach items="${funcionarios}" var="funcionarioTO">
                                        <tr>        
                                            <td>
                                                <a title="Remover registro" class="btn btn-danger" href="mainControll?action=RemoverFuncionario<c:out value="${funcionarioTO.matricula}"/>"><span class="glyphicon glyphicon-remove"/></a>
